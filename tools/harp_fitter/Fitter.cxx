...
void Fitter::InitData(string fname) {
    ...
    if (file_name.find("2c21") > 2 && file_name.find("2c21") < 50) {
        ...
        min_3rd_hist = 78.;
        max_3rd_hist = 85.;
    } else if (file_name.find("2H01") > 2 && file_name.find("2H01") < 50) {
        fit_2H01 = true;
        harp_name = "harp_2H01";
        scale_Xaxis = 10.;
        min_1st_hist = 30.;
...
void Fitter::FitData(bool manual_fit, bool preview) {
    ...
    if (counters_box->GetSelected() >= 0) {
        ...
        if (manual_fit) {
            ...
            if (fit_2H01 || fit_2H00A || fit_2H02A || fit_2c21) {
                range_1st_peak[0] = First_peak_range_min->GetNumber() * sqrt2;
                range_1st_peak[1] = First_peak_range_max->GetNumber() * sqrt2;
            } else {
                range_1st_peak[0] = First_peak_range_min->GetNumber();
                range_1st_peak[1] = First_peak_range_max->GetNumber();
            }
            ...
            pars_bgr_1st_peak[1] = 0.;
            pars_bgr_1st_peak[2] = 5 * pars_bgr_1st_peak[0];


            pars_A_1st_peak[0] = h_bgr_Subtr->GetMaximum(); // max_val - pars_bgr_1st_peak[0];
            pars_A_1st_peak[1] = 0.5 * h_bgr_Subtr->GetMaximum();
            pars_A_1st_peak[2] = 2 * h_bgr_Subtr->GetMaximum(); //pars_A_1st_peak[2] = 2*max_val;

            double delt_mean_tolerance = 0.35;
            pars_mean_1st_peak[0] = h_1st_peak->GetBinCenter(h_1st_peak->GetMaximumBin());
            pars_mean_1st_peak[1] = pars_mean_1st_peak[0] - delt_mean_tolerance;
            pars_mean_1st_peak[2] = pars_mean_1st_peak[0] + delt_mean_tolerance;

            pars_sigm_1st_peak[0] = h_bgr_Subtr->GetRMS();
            pars_sigm_1st_peak[1] = 0.001 * pars_sigm_1st_peak[0];
            pars_sigm_1st_peak[2] = 1.1 * pars_sigm_1st_peak[0];

            // 2nd peak is always x or y, wire, therefore always should be multiplied by sqrt2
            range_2nd_peak[0] = Second_peak_range_min->GetNumber() * sqrt2;
            range_2nd_peak[1] = Second_peak_range_max->GetNumber() * sqrt2;
            ...
            pars_bgr_2nd_peak[1] = 0.;
            pars_bgr_2nd_peak[2] = 5 * pars_bgr_2nd_peak[0];

            pars_A_2nd_peak[0] = h_bgr_Subtr->GetMaximum(); //max_val - pars_bgr_2nd_peak[0];
            pars_A_2nd_peak[1] = 0.5 * h_bgr_Subtr->GetMaximum();
            pars_A_2nd_peak[2] = 2 * h_bgr_Subtr->GetMaximum(); //2*max_val;

            pars_mean_2nd_peak[0] = h_2nd_peak->GetBinCenter(h_2nd_peak->GetMaximumBin());
            pars_mean_2nd_peak[1] = pars_mean_2nd_peak[0] - delt_mean_tolerance;
            pars_mean_2nd_peak[2] = pars_mean_2nd_peak[0] + delt_mean_tolerance;

            pars_sigm_2nd_peak[0] = h_bgr_Subtr->GetRMS();
            pars_sigm_2nd_peak[1] = 0.;
            pars_sigm_2nd_peak[2] = 1.1 * pars_sigm_2nd_peak[0];

            if (fit_2H01 || fit_2H00A || fit_tagger || fit_2H02A) {
                if (fit_tagger) {
                    range_3rd_peak[0] = Third_peak_range_min->GetNumber() * sqrt2;
                    range_3rd_peak[1] = Third_peak_range_max->GetNumber() * sqrt2;
                } else {
                    range_3rd_peak[0] = Third_peak_range_min->GetNumber();
                    range_3rd_peak[1] = Third_peak_range_max->GetNumber();
                }
                ...
                pars_bgr_3rd_peak[1] = 0.;
                pars_bgr_3rd_peak[2] = 5 * pars_bgr_3rd_peak[0];

                pars_A_3rd_peak[0] = h_bgr_Subtr->GetMaximum(); //max_val - pars_bgr_3rd_peak[0];
                pars_A_3rd_peak[1] = 0.5 * h_bgr_Subtr->GetMaximum();
                pars_A_3rd_peak[2] = 2 * h_bgr_Subtr->GetMaximum(); // 2*max_val;
                pars_mean_3rd_peak[0] = h_3rd_peak->GetBinCenter(h_3rd_peak->GetMaximumBin());
                pars_mean_3rd_peak[1] = pars_mean_3rd_peak[0] - delt_mean_tolerance;
                pars_mean_3rd_peak[2] = pars_mean_3rd_peak[0] + delt_mean_tolerance;
                pars_sigm_3rd_peak[0] = h_bgr_Subtr->GetRMS();
                pars_sigm_3rd_peak[1] = 0.001 * pars_sigm_3rd_peak[0];
                pars_sigm_3rd_peak[2] = 1.1 * pars_sigm_3rd_peak[0];
            }
        } else {
            if (fit_2c21) {
                good_parameters = Search_2c21_peaks(gr_[counter_ind]);
            } else if (fit_2H01 || fit_tagger || fit_2H02A || fit_2H00A) {
                good_parameters = Search_three_peaks(gr_[counter_ind]);
            }
        }
        ...
        if (good_parameters) {
            ...
            c1->cd(2)->Modified();
            c1->cd(2)->Update();
            if (fit_tagger || fit_2H02A || fit_2H01 || fit_2H00A) {
                c1->cd(3)->Modified();
                c1->cd(3)->Update();
            }
        } else {
...
void Fitter::Set_Fit_Pars() {
    if (!f_Main_FitPars) {
        ...
        if (fit_tagger || fit_2H02A || fit_2H00A || fit_2H01) {
...
bool Fitter::Search_2c21_peaks(TGraph *gr) {
    ...
    if (n_peaks == 2) {
        ...
        pars_bgr_1st_peak[0] = bgr_average;
        pars_bgr_1st_peak[1] = 0.;
        pars_bgr_1st_peak[2] = 10 * bgr_average;
        pars_A_1st_peak[0] = tmp_Ampl;
        pars_A_1st_peak[1] = 0.1 * tmp_Ampl;
        pars_A_1st_peak[2] = 1.5 * tmp_Ampl;
        pars_mean_1st_peak[0] = mean_x;
        pars_mean_1st_peak[1] = mean_x - 2;
        pars_mean_1st_peak[2] = mean_x + 2.;
        pars_sigm_1st_peak[0] = tmp_RMS;
        pars_sigm_1st_peak[1] = 0.001 * tmp_RMS;
        pars_sigm_1st_peak[2] = 100 * tmp_RMS;
        range_1st_peak[0] = mean_x - 3.5;
        range_1st_peak[1] = mean_x + 3.5;
        ...
        pars_bgr_2nd_peak[0] = bgr_average;
        pars_bgr_2nd_peak[1] = 0.;
        pars_bgr_2nd_peak[2] = 10 * bgr_average;
        pars_A_2nd_peak[0] = tmp_Ampl;
        pars_A_2nd_peak[1] = 0.1 * tmp_Ampl;
        pars_A_2nd_peak[2] = 1.5 * tmp_Ampl;
        pars_mean_2nd_peak[0] = mean_x;
        pars_mean_2nd_peak[1] = mean_x - 2;
        pars_mean_2nd_peak[2] = mean_x + 2.;
        pars_sigm_2nd_peak[0] = tmp_RMS;
        pars_sigm_2nd_peak[1] = 0.001 * tmp_RMS;
        pars_sigm_2nd_peak[2] = 100 * tmp_RMS;
...
bool Fitter::Search_three_peaks(TGraph *gr) {
    ...
    if (n_peaks == 3) {
        ...
        pars_bgr_3rd_peak[0] = bgr_average;
        pars_bgr_3rd_peak[1] = 0.;
        pars_bgr_3rd_peak[2] = 10 * bgr_average;
        pars_A_3rd_peak[0] = tmp_Ampl;
        pars_A_3rd_peak[1] = 0.1 * tmp_Ampl;
        pars_A_3rd_peak[2] = 1.5 * tmp_Ampl;
        pars_mean_3rd_peak[0] = mean_x;
        pars_mean_3rd_peak[1] = mean_x - 2;
        pars_mean_3rd_peak[2] = mean_x + 2.;
        pars_sigm_3rd_peak[0] = tmp_RMS;
        pars_sigm_3rd_peak[1] = 0.001 * tmp_RMS;
        pars_sigm_3rd_peak[2] = 100 * tmp_RMS;
        range_3rd_peak[0] = mean_x - 3.5;
        range_3rd_peak[1] = mean_x + 3.5;
...
bool Fitter::Fit_2H01(TGraph *gr, string counter_name) {
    TLatex *lat1 = new TLatex();
    lat1->SetNDC();
...
bool Fitter::Fit_2H02A(TGraph *gr, string counter_name) {
    ...
    if (n_peaks == 3) {
        ...
        double *alpha_a_b = Calc_abalpha(sigm_[2], sigm_[1] * TMath::Sqrt(2.), sigm_[0] * TMath::Sqrt(2.));
