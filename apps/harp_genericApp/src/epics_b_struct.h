...
struct epics_rec {
  ...
  {"MBC2H00H.BDL"       ,  "2H00 H corrector BDL (gauss-cm)"},
  {"MBC2H00V.BDL"       ,  "2H00 V corrector BDL (gauss-cm)"},
  {"MBC2H02H.BDL"       ,  "2H02 H corrector BDL (gauss-cm)"},
  {"MBC2H02V.BDL"       ,  "2H02 V corrector BDL (gauss-cm)"},
  {"EOL"                ,  "EOL"}
};
