...
//===============================================================================================
//===============================================================================================
static long init_aao(struct aaoRecord  *paao)
{
...
//===============================================================================================
static long write_aao(struct aaoRecord *paao)
{
//int crate; 
//int slot; 
//int channel;
...
//===============================================================================================
static long read_waveform(struct waveformRecord *pwi)
{
...
//static int iii=0;
 ...
 // *((unsigned long*) (pwi->val))=5;
    IocGetWaveformLength(chassis, slot, channel, &len);
    if(len<=0)return OK;
//    values = (unsigned long *) malloc(sizeof(long)*len);
 ...
 ///for (pwi->nord = 0; pwi->nord < pwi->nelm; pwi->nord++){
   for (pwi->nord = 0; pwi->nord < len; pwi->nord++){
...
/*
	...
	i = 0;
	while( i < MAX_HVPS  &&  strcmp(Measure[i].name, mf) != 0) i++; /// my: MAX_CRATES
	...
	if(slot == -1) {
		snprintf(prec->val, sizeof(prec->val),"%s", Measure[i].IPADDR );
	} else if (slot>=0) {
