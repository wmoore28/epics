...
dbLoadRecords("db/iocAdminSoft.db","IOC=MTRHLD")

epicsEnvSet("PREFIX","")
### Motors
dbLoadTemplate "db/xpsHallD.substitutions"
dbLoadRecords "db/collimators.db", "P=US1-2-BOT:, R=m1, pref=${PREFIX}"
dbLoadRecords "db/converters.db" , "P=US1-2-BOT:, R=m2, pref=${PREFIX}"
...
XPSCreateController("US1-2-BOT", "us1-2-bot", 5001, 8, 10, 500, 0, 500)
...
XPSCreateAxis("US1-2-BOT", 0, "Collimator.X",   "79")

# for integer number for stepSize , MRES = 0.007936508, stepSize = 126
XPSCreateAxis("US1-2-BOT", 1, "Converter.Pos",   "126")
