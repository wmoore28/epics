...
dbLoadRecords("db/dbHybSyncDataDpmAll.db","DPM=5,HYB=0")
dbLoadRecords("db/dbHybSyncDataDpmAll.db","DPM=5,HYB=1")
dbLoadRecords("db/dbHybSyncDataDpmAll.db","DPM=5,HYB=2")
dbLoadRecords("db/dbHybSyncDataDpmAll.db","DPM=5,HYB=3")
dbLoadRecords("db/dbHybSyncDataDpm.db","DPM=5,HYB=0")
dbLoadRecords("db/dbHybSyncDataDpm.db","DPM=5,HYB=1")
dbLoadRecords("db/dbHybSyncDataDpm.db","DPM=5,HYB=2")
dbLoadRecords("db/dbHybSyncDataDpm.db","DPM=5,HYB=3")
