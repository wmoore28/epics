...
dbLoadRecords("db/dbHybSyncDataDpmAll.db","DPM=7,HYB=0")
dbLoadRecords("db/dbHybSyncDataDpmAll.db","DPM=7,HYB=1")
dbLoadRecords("db/dbHybSyncDataDpmAll.db","DPM=7,HYB=2")
dbLoadRecords("db/dbHybSyncDataDpmAll.db","DPM=7,HYB=3")
dbLoadRecords("db/dbHybSyncDataDpm.db","DPM=7,HYB=0")
dbLoadRecords("db/dbHybSyncDataDpm.db","DPM=7,HYB=1")
dbLoadRecords("db/dbHybSyncDataDpm.db","DPM=7,HYB=2")
dbLoadRecords("db/dbHybSyncDataDpm.db","DPM=7,HYB=3")
