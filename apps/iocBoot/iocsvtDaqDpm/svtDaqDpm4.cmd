...
dbLoadRecords("db/dbDataDpmStatus.db","DPM=4")
dbLoadRecords("db/dbDataDpmEventState.db","DPM=4")
dbLoadRecords("db/dbDataDpmBlockCount.db","DPM=4")
dbLoadRecords("db/dbDataDpmSystemState.db","DPM=4")
dbLoadRecords("db/dbDataDpmBurnCount.db","DPM=4")
dbLoadRecords("db/dbDataDpmInsertedFrames.db","DPM=4")
dbLoadRecords("db/dbDataDpmEBEventErrorCount.db","DPM=4")
dbLoadRecords("db/dbDataDpmEventCount.db","DPM=4")
dbLoadRecords("db/dbDataDpmTrigCount.db","DPM=4")
dbLoadRecords("db/dbDataDpm.db","DPM=4")
dbLoadRecords("db/dbHybSyncDataDpmAll.db","DPM=4,HYB=0")
dbLoadRecords("db/dbHybSyncDataDpmAll.db","DPM=4,HYB=1")
dbLoadRecords("db/dbHybSyncDataDpmAll.db","DPM=4,HYB=2")
dbLoadRecords("db/dbHybSyncDataDpmAll.db","DPM=4,HYB=3")
dbLoadRecords("db/dbHybSyncDataDpm.db","DPM=4,HYB=0")
dbLoadRecords("db/dbHybSyncDataDpm.db","DPM=4,HYB=1")
dbLoadRecords("db/dbHybSyncDataDpm.db","DPM=4,HYB=2")
dbLoadRecords("db/dbHybSyncDataDpm.db","DPM=4,HYB=3")
