...
dbLoadRecords("db/dbDataDpmStatus.db","DPM=6")
dbLoadRecords("db/dbDataDpmEventState.db","DPM=6")
dbLoadRecords("db/dbDataDpmBlockCount.db","DPM=6")
dbLoadRecords("db/dbDataDpmSystemState.db","DPM=6")
dbLoadRecords("db/dbDataDpmBurnCount.db","DPM=6")
dbLoadRecords("db/dbDataDpmInsertedFrames.db","DPM=6")
dbLoadRecords("db/dbDataDpmEBEventErrorCount.db","DPM=6")
...
dbLoadRecords("db/dbHybSyncDataDpmAll.db","DPM=6,HYB=0")
dbLoadRecords("db/dbHybSyncDataDpmAll.db","DPM=6,HYB=1")
dbLoadRecords("db/dbHybSyncDataDpmAll.db","DPM=6,HYB=2")
dbLoadRecords("db/dbHybSyncDataDpmAll.db","DPM=6,HYB=3")
dbLoadRecords("db/dbHybSyncDataDpm.db","DPM=6,HYB=0")
dbLoadRecords("db/dbHybSyncDataDpm.db","DPM=6,HYB=1")
dbLoadRecords("db/dbHybSyncDataDpm.db","DPM=6,HYB=2")
dbLoadRecords("db/dbHybSyncDataDpm.db","DPM=6,HYB=3")
